...
A machine learning project that predicts the genre of a movie based on its plot summary. 
The model classifies movies into genres like Action, Romance, Thriller, Drama, or Comedy using text-based features.
